...
Budget: aim to answer within ~15 tool calls. If you haven't found it by then, stop and report your best findings plus exactly what you searched - a fast partial answer the orchestrator can redirect beats an exhaustive sweep.
